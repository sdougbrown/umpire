...
description: A five-step PC builder wizard showing how one CPU change cascades into three fouls — Umpire availability rules driving a multi-step configuration flow.
---
...
- [Config-Driven UI, With Behavior](/examples/config-driven-ui/) — the same cascade story, but authored entirely in portable JSON and hydrated at runtime.
