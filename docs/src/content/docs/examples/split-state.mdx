...
description: Account settings with one shared store and three isolated Umpire sections — demonstrates how select() maps a single store slice to multiple independent availability graphs.
---
