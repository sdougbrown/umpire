...
A login form where the submit button depends on both field values *and* an external captcha token. Shows how conditions-driven rules and reasons aggregation work together.
