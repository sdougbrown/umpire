---
title: 'Signals — Vue'
description: Connect @umpire/signals to Vue 3 reactivity for fine-grained Umpire availability tracking — reactive refs update automatically as field values change.
---
