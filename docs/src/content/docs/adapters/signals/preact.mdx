...
description: Connect @umpire/signals to @preact/signals-core for fine-grained reactive Umpire availability — components auto-subscribe, no effects or manual bridging needed.
---
