---
title: Quick Start
description: Hands-on introduction to Umpire's availability rules — requires, disables, oneOf, fairWhen, and more — with live interactive examples you can run in the browser.
---
...
<div class="c-umpire-demo c-learn-demo">
...
- Read [Availability](/concepts/availability/) for the mental model behind `enabled`, `required`, and reason precedence.
- Browse [Rule Primitives](/api/rules/) for full helper signatures, defaults, and composition rules.
- See the [Signup example](/examples/signup/) and the [React adapter](/adapters/react/) when you want a larger end-to-end form.
