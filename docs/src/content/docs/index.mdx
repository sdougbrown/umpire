...
<div class="umpire-minefield-callout">
  <div class="umpire-minefield-callout__demo">
    <MinesweeperDemo client:load compact />
  </div>
  <div class="umpire-minefield-callout__copy">
    ...
    <p>
      Three <code>enabledWhen</code> rules per cell. 192 rules total. <strong>1ms</strong> to evaluate the entire board.
    </p>
